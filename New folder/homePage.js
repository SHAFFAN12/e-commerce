...
//     document.getElementsByClassName("Cart")[0].innerTextv= updatedCart
...
function showcart() {
    ...
    for (let so of a){
        let mainDiv = document.createElement('div')
        let headingText = document.createTextNode(so.description)
        let heading = document.createElement('h2')
        heading.appendChild(headingText)
        mainDiv.appendChild(heading)
        let descriptionText = document.createTextNode(so.p)
        let description = description.createElement('p')
        description.appendChild(descriptionText)
        mainDiv.appendChild(description)
        // let button text
